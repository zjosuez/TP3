...
import controler.ControleRoupaEAcessorio;
import model.Dados;

public class CadastrarRoupaEAcessorio extends JFrame implements ActionListener{
	private final ControleRoupaEAcessorio controler;
	...
	public CadastrarRoupaEAcessorio() {
		
		controler = new ControleRoupaEAcessorio(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(src == cadastrarbtn) {
			controler.cadastrarRoupaEAcessorio();
